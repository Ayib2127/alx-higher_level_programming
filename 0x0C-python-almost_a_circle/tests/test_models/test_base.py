...
OBOBOB        self.assertTrue(type(json_l[1]) is dict)
        self.assertEqual(json_l[0],
OBOBOB                         {"id": 9, "width": 5, "height": 6, "x": 7, "y": 8})
        self.assertEqual(json_l[1],
OBOBOB                         {"id": 2, "width": 2, "height": 3, "x": 4, "y": 0})

    def test_fjs_empty(self):
OBOBOB        """Tests from_json_string with an empty string"""
